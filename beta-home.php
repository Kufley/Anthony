...
</html><?php if (file_exists($_SERVER['DOCUMENT_ROOT'].'/zblock/zbblock.php')) require($_SERVER['DOCUMENT_ROOT'].'/zblock/zbblock.php'); ?><?php
  ...
  <div class="med_area">
    <div class="med_arealeft">
      <div class="meetanthony_area">
       ...
       <video class="newarea"><source src="video/GLYCEMIC INDEX.MTS"></video>
    </div>
