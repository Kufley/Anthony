...
<!--                        <input type="image" border="0" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynowCC_LG.gif"-->
<!--                               name="submit" alt="PayPal - The safer, easier way to pay online!">-->
                    ...
                    <li class="text-center">After logging into your paypal account, send payment to <a
                            href="mailto:Anthony@WeightLossHappens.com">Anthony@WeightLossHappens.com</a></li>
                </ol>
            </div>
        </div>
    </div>
