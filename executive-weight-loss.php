    ...
    <div class="med_arealeft">
      <div class="meetanthony_area">
        ...
        <div class="meetanthony_left">
          <div class="meetanthony_top"> <a href="about-anthony.php"><img src="images/meetanthony2.png" alt="meetanthony" width="208" height="222" /></a> </div>
          <div class="meetanthony_bottom"> <a href="about-anthony.php">Anthony Wilson</a>, <span> RD, MS</span>
            <div class="dietitian">Dietitian, Therapist </div>
          </div>
        </div>
      ...
      <div class="stages_area new_page">
        <div class="stages_main">
          ...
          <div class="stages_rowarea1">
            <div class="awareness_col1">
              <div class="big_picture_col1_align"> <a href="#" name="sus" onClick="openPopup('fadefriend',1,'fade_popup','datafriend',2,'data_on_fade','contect8');">10 Additional Hours (click Here)</a>
          ...
          <div class="stages_rowarea1">
            ...
            <div class="bronzeprogram_col2">
              	<div class="bronzeprogram_col2_align">
                	<a class="bronze" href="<?php echo $config['site_url'];?>bronze-landing.php"><br />HELP ME LOSE WEIGHT NOW!</a>
                </div>
            </div>
            <div class="bronzeprogram_col2">
              	<div class="bronzeprogram_col2_align">
                	<a class="silver" href="<?php echo $config['site_url'];?>silver-landing.php"><br />HELP ME LOSE WEIGHT NOW!</a>
                </div>
            </div>
            <div class="bronzeprogram_col4">
              <div class="bronzeprogram_col2_align">
                <a class="gold" href="<?php echo $config['site_url'];?>gold-landing.php"><br />HELP ME LOSE WEIGHT NOW!</a>
              </div>
            </div>
          </div>
        </div>
