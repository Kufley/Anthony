	...
	function validate(&$request)
	{
		...
		foreach ($this->elems as $e) {
			...
			foreach ($val as $k => $v) {
				...
				if ( in_array($e['type'], array('text','image','video'))) {
					...
					if (isset($e['cont']) && in_array($e['cont'], array('email', 'alpha', 'word', 'digit', 'decimal','allowAlphaNumSpace','allowAlphaNumNoSpace','telephone','urlFromWww','domainName','AWScatName','chkpassword','imgval','nameVal','videoval'))) {
