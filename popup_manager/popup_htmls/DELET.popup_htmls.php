                ...
                <div class="popup_weightarticle_contents">
                   <img src="images/Increase2.png" class="popup_weightarticle1" alt="Increase2">
                    ...
                    <p>First, it allows us to become aware of what we are actually eating.</p>
                   	...
                   	<p> Because so many people 'pick' throughout the day, most of us really aren't aware of how many different foods we have consumed.</p>
                    <p>When I have looked over a client's food journal and asked them about a specific food item they consumed, often times they will look at me quite puzzled, and say, &quot;Did I really eat that?&quot;</p> Becoming aware of what you are actually eating is the first step towards successful weight loss!
                    ...
                    <h2>Don't do this</h2>
                    <p>A good example of why it's important to keep a food journal would be the case of eating chips right out of the bag. When we eat chips right out of the bag we aren't aware of how much we are consuming while we are eating them. And then we walk away after we're done not aware of how many calories all those chips just added up to. If we are keeping a food journal, we would have to write down how much we just ate which would facilitate us in determining how many calories we just consumed. One of the additional benefits to this is that since we are calories conscious, this would encourage us to measure out a specific amount the next time we reach for a bag of chips!</p>

                    <h2>Summary</h2>
                    <p>Simply, keeping a food journal greatly facilitates us in becoming aware of what foods, and how much of them, we are consuming, and how many total calories we are taking in for the entire day. Because of this, when we are snacking we tend to consume less food and less calories which often times leads to losing weight fast or not gaining it in the first place!</p>
                </div>
            </div>
        </div>
        </div>
