            ...
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                   <img src="images/Increase2.png" class="popup_weightarticle1" alt="Increase2">
                    ...
                    <h2>Summary</h2>
                    <p>Simply, keeping a food journal greatly facilitates us in becoming aware of what foods, and how much of them, we are consuming. It also helps us to determine how many total calories we are taking in for the entire day. Subsequently, when we are snacking we tend to consume less food and less calories which often times leads to losing weight faster or not gaining the excess weight it in the first place!</p>
                </div>
            </div>
        </div>
        </div>
