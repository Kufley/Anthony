    ...
    <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>The information you report back to me enables me to be aware of what medical issues may be impacting your weight and weight loss efforts. For instance, if you are female and have had one or both of your ovaries removed, that would allow me to see why your metabolism is lower than what I would expect it to be. Or, if you were overweight as a child I would need to know that because it would make me aware of your individualized physiology and what struggles I could expect you to see in the future.
</p>
                    <p>Additionally, since we will be putting together your eating plan it is imperative that I know your entire medical history. If you had your gallbladder removed and need to consume low fat meals (even if the fats are 'healthy' fats)  to prevent complications, I need to know that.
</p>
					<p>Another example would be if you have a history of hypertension and / or hypercholesterolemia, that's something I need to be aware because it will have an impact on your dietary recommendations. Besides focusing on losing weight and permanently maintaining that weight loss, which should automatically make you healthier overall, we will work together to prevent sickness, disease and death. </p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Recent blood work is analyzed to detect nutritional deficiencies, possible disease states, areas that need extra focus and attention, and to facilitate creating the best dietary prescription for you. For example, when it comes to your overall health, and in particular, your capacity to be physically active, your red blood cell, hemoglobin and iron levels are critical. </p>
                    <p>Being deficient in any of these categories (among other categories) will make it much more difficult for you to burn a maximum number of calories when exercising, as well as burning calories when you are not exercising. Additionally, when you have blood work deficiencies, you generally are not feeling as strong as you could be which can make it easier for you to get tired throughout the day which lends itself to making poorer food choices. </p>
                    <p>Upon noticing any deficiencies, your diet will be devised to target these deficiencies and get them to normal or higher levels. When your medical doctor orders blood tests for you, if they see a deficiency they will likely tell you about the deficiency and make a suggestion in which that suggestion may leave a lot to be interpreted. Generally, that is all you'll get from them if for no other reason than they don't have the time to go into depth with you about it. </p>
                    <p>I DO go into depth with you about it! For instance, we discuss how it may have happened, what you need to do to prevent it from getting worse, how to make it better including exactly which food sources we need to include in your diet, how much, how often, with or without what other food sources, and what your optimal blood levels should be.</p>
                    <p>Additionally, many doctors do NOT do complete blood tests. Often they leave out key blood tests which upon noticing I may recommend that they order those blood tests so that we can see the entire picture with your current health and blood status. Getting your blood work to healthy levels can have a big impact on your ability to reach your dream weight!</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Part of seeing the 'Big Picture' with your weight management involves determining what your current roadblocks and obstacles are that are preventing you from attaining a healthy weight. You can have roadblocks that are getting in your way of exercising as well as roadblocks that are inhibiting your ability to consume a healthier diet.</p>
                    <p>It's very important to know what the problem is, but it is critical to know why the problem is there. This assessment also helps to facilitate determining what's at the core of your challenges. Determining what these roadblocks and obstacles are, and what's at the core of them is absolutely imperative, just as devising a plan to overcome them is. </p>
                    <p>You have your own personal needs – things that are essential for you to be successful with your weight loss goal. Your needs are in part based upon your personal circumstances, the challenging areas you are dealing with, your medical and food history and more.</p>
                    <p>Without knowing what your true needs are, it is very difficult to create a solution to the problem that will be effective long–term. Together, we'll determine what you'll need to overcome your roadblocks and obstacles so that you can start making significant progress with your weight loss goal and soon reach your dream weight!</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Goal orientation focuses on the initiation of determining what your long-term goals are as well as what short-term goals you will need in order to be successful with accomplishing your long–term goals. It is imperative to set goals at the very start of your program, however, goals can be modified at any time. </p>
                    <p>For example, if you need more time to achieve a short-term goal, you can modify the timeline for the accomplishment of that goal. Without making modifications at times, many people will fall short of accomplishing their goals and therefore abandon their goals altogether and find themselves starting all over again later on.</p>
                    <p>However, goals are created to give you drive and focus! Having a timeline for a goal and doing everything you can to achieve that goal within that timeline is really critical. Without having a deadline to meet, goals do not have the impact that they are meant to have. </p>
                    <p>When you are doing your best to meet a goal, but unforeseen circumstances arise or you realize you made your goal too profound for that short period of time, it may be best to modify your goal. In addition to being time sensitive, goals should be specific, measurable, attainable, and realistic.</p></div>
                </div>
            </div>
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>The food assessment helps us to see what the big picture is with your eating patterns and habits. It focuses on what you have been eating, what you are currently eating, and to some extent, what the underlying causes of your eating patterns and habits are. </p>					<p>It also allows us to see if you have any major nutritional deficiencies. The food assessment generally yields a tremendous amount of important information and is a major key at the beginning of your program.</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>This involves looking at how you view certain foods and key nutrients, and then educating you as to whether or not you hold accurate beliefs regarding them, and why. This is important because inaccurate food and nutrient beliefs are likely affecting your food choices which may be hindering your ability to be successful with your daily, short and long–term goals. </p>

					<p>Being unsuccessful with your daily & short-term goals with have a tremendous negative impact on your ultimate long-term weight loss goal. Your beliefs will have a direct impact on your actions regarding food intake.</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Food recognition ultimately involves recognizing the overall reasons why you are eating the way you are and why your habits and patterns exist. This then leads to determining what needs to be changed to eradicate these behaviors.</p>

					<p>For instance, if you were going long periods of time without food, that would help me to recognize why you are binging on sugary and fatty snacks, and at least partially, what we need to do about it. Food recognition is the ultimate key when it comes to being more aware as to why we are eating they way we are.</p></div>
                </div>
            </div>
            <!--<div class="foodassessment_main2">
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Now that we have the vital information from the food awareness section and know what your negative eating patterns and habits are, and why they exist, we'll also identify if you actually want to change those behaviors and habits, and why or why not. Additionally, we'll identify how far out of your comfort zone you are willing to go and then create a plan to modify your current eating patterns and habits so that you can create new, empowering eating patterns and habits. </p>

					<p>Together, we'll determine how to deal with them most effectively, and ultimately, how to go about making the needed changes. Simply, we are going to utilize behavioral psychology techniques to facilitate the transitioning of negative behaviors to positive ones.</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>To begin any journey you must be motivated to get started. To finish any journey, you must stay motivated along the way. And when you hit unforeseen roadblocks and obstacles, your motivation needs to be there in full force to support you or else you may give up and lose all the gains that you have made thus far. </p>

					<p>What drives one person doesn't necessarily drive another one, which is why, together, we'll create your 'personalized' motivational blueprint that will act as your driving force to keep you on cue with all of your goals. Motivation is power! Let it drive you to your dream weight!
</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Did you know that your thoughts have a tremendous impact on your feelings and that your feelings affect your actions? Since your thoughts have such a strong impact on your behaviors, we'll identify how you speak to yourself and whether or not that is positively or negatively impacting your weight loss efforts. </p>

					<p>Learning to look at things from a positive perspective as well as looking at change as an opportunity will be two of our goals that will facilitate you in achieving powerful thinking which will greatly facilitate you on your weight loss journey. </p></div>
                </div>
            </div>
            <!--<div class="foodassessment_main2">
          ...
          <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Stress is often a prime culprit with weight gain and the struggle to reach a healthy body weight. This is because of its impact on emotional eating, appetite, the amount you eat, when you eat, and its connection to emotional eating. </p>
					<p>The exhaustion that stress can impart can lead to decreased quality sleep, less energy, less calories burned during a workout, skipped meals, excessive snacking, and poor food choices like foods high in simple sugars and fat.</p>
					<p>If stress is having an impact on your level of happiness and contentment, it is most likely having an impact on your dietary habits. Stress is physiologically dangerous. Among other effects, it weakens your immune system, can lead to permanent short–term memory loss, and promotes that dreaded belly fat!
</p></div>
                        </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Together, we will determine what the true causes of your stress are and what we must do, from a food, activity and behavioral standpoint, to eliminate and/ or cope with these stressors so that your long-term weight loss goal can still be achieved. There are many different things that you can do in regards to your stress including utilizing many cognitive and behavioral techniques to prevent it from occurring, or manage it should your stress start to rise. </p>

					<p>Obviously, exercise is a great way to keep a lid on stress in many instances, but it does not target its root cause. So we will counter stress from 3 perspectives: preventing it, controlling it and eliminating it when possible. </p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>If stress is having a large impact on your weight then one of our first priorities is to make preventing, managing and overcoming your stress immediate goals. Too much stress can be a tremendous roadblock to your weight loss success. </p>

					<p>Creating daily and short-term goals that target stress will be a great start to removing this roadblock! Part of your long-term plan and 'recipe for success' will involve these short-term goals that target your stress so that you have the best chance for success with achieving your long-term goal! </p></div>
                </div>
            </div>
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main" style="padding-top:15px;">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>To get the most out of your exercise plan, you need to utilize the correct nutrients, in the correct amounts, and at the correct time! This involves determining how much carbohydrate, protein, and fat to have before and after your workouts, as well as for your entire day. </p>

					<p>Utilizing proper sports nutrition will facilitate you in having more intense workouts, recovering from your workouts more quickly, decreasing your chances of injury, and feeling better after your workout. And that's in addition to burning a maximum number of calories during and after your workout.
</p></div>
                </div>
            </div>
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main" style="padding-top:15px;">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Without having goals and a success plan, many people aimlessly wander about wanting to reach their dream weight, but year after year they never get there. To start off your success plan, we identify what we've decided is your long–term goal and the date by which you want to accomplish it by. </p>

					<p>Next, we decide what the short–term goals are that you'll need in order to be successful with achieving your long-term goal. We'll also create daily-goals that help you to stay focused each and every day! </p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Based on all of the information we've gathered thus far, we will put together a 'Recipe For Success' so that you can make your dream weight a reality! This will take into account what your circumstances and needs are, your likes, dislikes, what motivates you, and the specific actions you'll need to take to accomplish your goals!</p>

					<p>Your 'recipe-for-success' can be modified at any time. When you have a significant amount of weight to lose, your weight loss journey is definitely a process. It does not happen overnight and your recipe-for-success will likely change over time depending upon how successful you have been and what your current circumstances are. Either way, there are many important ingredients in your own personalized recipe!
</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Additionally, we will create sample food lists, sample meals, and sample meal plans based on your food preferences. Your sample meal plans will have menus that keep you full throughout the day and still losing weight. They will only include foods that you enjoy and will be based upon your daily needs, goals and medical conditions. </p></div>
                </div>
            </div>
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Now you've started to put your 'Success Plan' into motion! Obstacles and unforeseen circumstances are inevitable and we will tackle them together as they arise. One of the main reasons why individuals don't reach their weight loss goal when working without the help of a professional is that they let their new obstacles and circumstances bring them to a screeching halt. </p>

					<p>Maintaining motivation throughout your weight loss journey is imperative. Working with a professional whereby obstacles are overcome and don't act as roadblocks, at least not for very long, allow you to continue to be successful which is key for maintaining motivation.</p>
					<p>Additionally, maintaining success is further enhanced by having someone hold you accountable. I will hold you accountable! Just knowing that someone is holding you accountable goes a long way – further than you might have imagined. So accountability is powerful! </p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="topic_content"><p>Working together for 6 full months will act as a driving force to keep you motivated for many reasons. Everyone is motivated by similar things as well as by things solely unique to them. We will determine what motivates YOU and use that to keep you going strong! </p>

				<p>We will be utilizing goal-setting to further enhance and maintain your motivation. Together we'll create daily, short & long-term goals and design them so that you'll achieve each one, and each one will enable you to accomplish the next one, and ultimately, your dream weight long-term goal! Having expert support and someone holding you accountable will further enhance motivation tremendously. </p>
				...
				<p>Additionally, knowing you have someone to answer to motivates and encourages you to do what's in your best interests.</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                   ...
                   <div class="topic_content"> <p>By having a coach available to you 24/7, you'll always have a resource available that you'll need to be successful. When trying to decide on what to eat, or how much, or how to go about doing something we discussed in one of your sessions, you may find it quite useful to contact me via email for a much needed question at just about any time. </p>

					<p>Again, this helps to keep you successful and motivated, knowing all the while that you are not alone - you have a partner that is here to assist you! And that's motivating! Short answer questions are perfect email questions while larger topics will be discussed during your sessions. Everyone loves having a coach they can reach out to 24/7!</p></div>
                </div>
            </div>
        ...
        <div class="awarenesspopup_bottom">
            <div class="foodassessment_main">
              <div class="minute_session">30 minute session per week</div>
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>By the end of the 1st 3-months you will be well on your way towards your weight loss goal!</p>
                    <p>However, many people lose weight, but then their motivation decreases and they start to regress with their new habits and behaviors, and eventually, their weight loss. You must remember that the journey is not nearly over at the 3-month mark! You must keep going in order to be successful. </p>
					<p>And we will keep it going with weekly 30 minute sessions whereby you'll continue to receive support, accountability, motivation, meals, goal-setting, and more! There's no point in making progress initially just to let it all slip away. At this point you have to maintain your past success as well as continue to have new successes.</p>

					<p>One of the biggest mistakes I see people make is that they get started on the right path, start making progress, and then think that the rest will come without continuously taking an intense approach. Just as you utilized expert support and targeted many different areas in your 1st 3-months, you must continue to do the same if you truly want to reach your dream weight goal!   </p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Without maintaining progress and newly created powerful habits, successful follow-through doesn't occur. Continued guidance and support play a huge role with sustainability, as does enjoyment with your food and activity plan. Having someone who really supports your efforts and is there for you 24/7, is motivating and empowering! People tend to put forth their best effort when they know someone else is counting on them to be successful. Continued guidance & support will be key!</p></div>
                </div>
            </div>
            ...
            <div class="foodassessment_main2">
                ...
                <div class="foodassessment_content">
                    ...
                    <div class="topic_content"><p>Each week we'll discuss successes and obstacles from the previous week and create strategies that will empower and facilitate your success for the upcoming week. With your help and focused effort, I'll see to it that we'll create a strategy to overcome any obstacle or roadblock that appears so that you can finish what you started and continue down your path towards you dream weight goal! </p>

<p>We'll look back and see what has worked for you in the past for similar obstacles and let that guide us. I'll also make sure you are aware of resources available to you so that you can stay feeling empowered. Just remember........Weight Loss Happens, with the right strategy! </p></div>
                </div>
            </div>
            ...
            <div class="popup_weightarticle_main">
                ...
                <img src="images/doctor.png" class="popup_weightarticle1" alt="fat_grams2">
                   <h2>LOSS OF MOTIVATION MUCH MORE LIKELY:</h2>
                    <p>One of the top motivators that keeps individuals continuing their weight loss journey is SUCCESS! Simply, working with a professional greatly increases your chances of success with your weight loss and that initial success will be critical for maintaining motivation as you move forward down your weight loss path. </p>
                    <p>This happens for numerous reasons such as when you are working with someone you are aware that the individual you are working with is counting on you to be successful. Often in a working relationship your desire is to be successful first and foremost for yourself, but also, you don't want to let the person assisting you down and that can be very motivating for you especially at times when you might otherwise falter.</p>

<p>Similarly, having this other person hold you accountable keeps you on your toes and you are more inclined to do what's in you best interests, and with this, you attain more success which fuels your motivation very positively!</p>

                    <h2>BURNING LESS CALORIES DUE TO DEFICIENT BLOOD WORK: </h2>
                    <p>Not being aware of what your blood work is showing and not knowing exactly what you need to do for it can cost you in terms of weight loss. For instance, when your red blood cell count, hemoglobin, and iron levels are low, that can have a large negative impact on your ability to burn calories.</p>
                    <p>Even though you may have had these tests run previously, they may not have been tested in some time. Also, your doctor rarely has the time to go over your blood work in depth with you such as discussing how and why your blood work got low, and exactly what you need to do to get those levels back to normal and higher. </p>
                    <p>One of the 1<sup>st</sup> things I do with clients is discuss recent or brand new blood work. We determine what must be done to get your deficiencies corrected and then we apply it to your weight loss plan. </p>

                    <h2>SLOWER GAINS DUE TO INACCURATE NUTRITION & WEIGHT LOSS INFORMATION: </h2>
                    <p>When you don't have accurate nutrition and weight loss information by which to plan your weight loss journey, you end up making slower gains even though you think you are doing everything right. Sooner or later you start to struggle to lose any weight. Slower gains are common when you have inaccurate information and flawed strategies. </p>
                    <p>Consequently, many individuals find themselves starting over numerous times since they don't have much success due to basing their weight management plan on misinformation and often times poor planning as well.</p>

                    <h2>QUITTING DUE TO A LACK OF FOLLOW-THRU:</h2>
                    <p>Many individuals have been learning about weight loss for a long time, but ultimately don't come close to reaching their dream weight due to a lack of follow-through, plain and simple. This could be due to many reasons such as a lack of knowledge, fear, lack of initial success, or other reasons. Whatever the reason, follow-through is absolutely necessary for success! Working with a professional will almost always help you to follow-through.
</p>
					<h2>WEIGHT GAIN, NOT WEIGHT LOSS: </h2>
                    <p>Weight gain, not weight loss, due to unintentional yo-yo 'dieting' often occurs. Many individuals start their weight loss plan, but then for one reason or another, stop shortly thereafter. Unfortunately, the end result is a higher body fat percentage and a slower metabolism. This is the result of losing muscle and gaining fat mass which happens when you decrease your caloric intake for a while and then abruptly go back to eating the same number of calories that you were eating before you started your weight loss plan. </p>

					<p>When you make that abrupt change, your metabolism is lower and not expecting to get as many calories as you used to feed it just a short while ago. So you end up over-consuming calories during that time. It doesn't seem like you are over-consuming calories because that is the same number of calories you used to consume.</p>

                    <h2> SLOWER GAINS DUE TO POOR GOAL-SETTING:</h2>
                    <p>Another top key when it comes to motivation is goal-setting. It is very useful to make daily, short & long-term goals and to make them in a way that will benefit you the most. Many times individuals' goal-setting was not created ideally and it doesn't motivate them the way that it should, if at all. Goal-setting that really motivates helps to keep you focused and driven especially during difficult times! Effective goal-setting is critical!</p>

					<h2>TREMENDOUS FRUSTRATION: </h2>
                    <p>Not having someone you trust to turn to for advice when you hit obstacles or are unsure about which is the best way to proceed with something leads to, among other things, tremendous frustration. And then you guess as to what to do and likely end up being even more frustrated. This is one of the benefits of working with a trusted professional – you always have someone to turn to for expert advice! </p>

					<h2>SLOWER GAINS DUE TO THE BELIEF THAT YOU WILL NOT BE SUCCESSFUL: </h2>
                    <p>Many individuals trying to lose weight and maintain that weight loss have tried to do so in the past and have failed. Because of that many have adopted the belief that, as much as they truly want to lose weight, they won't be successful with losing weight. Ultimately, your limiting beliefs will affect your actions which will almost definitely have a negative impact on your food choices and how you forward with your weight loss plan. </p>

					<h2>SLOWER PROGRESS DUE TO DEFICIENT WEIGHT LOSS PRESCRIPTION:</h2>
                    <p>It's difficult for you to put together your best dietary “prescription” for your weight loss journey without taking into account your past and current medical conditions, among other things, and exactly how they factor in. For instance, if you have had your gallbladder removed you would need to know that you need to consume low fat meals for the rest of your life or else you will have chronic diarrhea, everyday. </p>

					<p>If you have diabetes you would need to know the most successful ways to plan your meals and snacks which would involve knowing the best ways to control and overcome your diabetes. Without nutrition and medical training you might be unaware of how to do this which would slow your progress down.</p>

					<h2>LESS CALORIES BURNED FROM A WORKOUT:</h2>
                    <p>Knowing what to eat before and after your workouts is critical so that you can get the most out of those workouts. Depending on what your goals are for your workouts, your nutrition prescription will vary. Many individuals base their pre- and post-workouts meals and snacks on false information and do not consume what will benefit them the most. The poorer your workout nutrition plan, the less energy you'll have for burning calories during your workouts.</p>
                </div>
                </div>
            </div>
        </div>
...
<?php if($popupFor=='contect21'){?>
    <div class="popup_weightarticle_area">
        <div class="popup_weightarticle_top">
            <div class="popup_weightarticle_left">Weight Loss Articles</div>
            <div class="popup_weightarticle_right">
            	<a href="javascript:void(0);" onclick="closeOpenedPopup('fadefriend,datafriend,wla02')" title="Close">X</a>
            </div>
        </div>
  	<div id="content_1" class="content">
        <div class="popup_weightarticle_bottom">
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                <div class="popup_weightarticle_hed">3 Keys to prevent overeating</div>
                    ...
                    <p>Problem #2: For our next meal We prepare more food than what our bodies really want or need simply because we are so hungry.</p>
                    <p>Problem #3: Now that we have a lot of food in front of us, we overeat simply because it is there and available to us. This leads to taking in a lot more calories than if we had snacked in between meals and had a smaller, portion-controlled meal afterwards.</p>
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                ...
                <p>Obviously this habit is detrimental to their weight loss efforts. Most clients who engage in this behavior are aware that it definitely interferes with their efforts to either lose weight or maintain their current weight.</p>
                    ...
                    <p>What's behind your bad habit? For different people it is something different. It could be one of the things mentioned above like stress or hunger, or another reason.</p>
                    ...
                    <p>And realize that your thoughts have a tremendous impact on your emotions and feelings. It would be nice to say, &quot;Just stay positive and your feelings and behaviors will be fine&quot;. Realistically, this is a good place to start because the more positive your thoughts, the more positive your feelings will be, in general.</p>
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                    ...
                    <p> of an issue with your meals than you do with your snacks. For instance, are you going too long in between meals in which you become ravenously hungry and snack excessively as a result? If so, your main obstacle here is with your meals, such as the timing and content.</p>
                    ...
                    <h2>Simple snack</h2>
                    <p>For a simpler snack, you could consume a small piece of fruit or half an apple with 1 tablespoon of peanut butter, a homemade bran muffin, or a low-carb protein bar, for example.</p>
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                    ...
                    <p>Have you ever considered that by having a job it can be hazardous to your weight? This can actually be true, to an extent. But before you decide to quit your job, continue reading...</p>

                    <h1>Colleague's snacks</h1>
                    <p>You may ask, &quot;How is this possible?&quot; Think of it this way. You start a new job and what do you know, your new colleagues have brought in some of your favorite, high calorie snacks.</p>
                    <p>Then you find yourself saying, &quot;Why did they have to bring that in today &ndash; I love those things!&quot; So what do you do, just resist temptation? You can try, but there is a better solution.</p>
                    ...
                    <p>Some coworkers at lunch time will want to go the cheapest route which will likely means your typical fast food establishment which has served zillions of customers over the years. In this situation, your options are limited and you are definitely in a more difficult situation.</p>
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                    ...
                    <p>Now that you know what your obstacle is and you are motivated to accomplish it, you need to ask yourself why is it there. Determining why the obstacle is there will give you tremendous insight as to how you are going to overcome it.</p>
                    ...
                    <p>Oddly enough, once you determine why your obstacle exists, then ask yourself why that reason (that you just came up with in step 2) exists. For instance, one of my former patients consistently overate at dinner time, which was his number one obstacle.</p>
                    ...
                    <p>For example:</p>
                    <p>&quot;What's the first thing that needs to be done, what will we need to do this, and how will we do it?&quot;</p>
            ...
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                  <img src="images/motivation2.png" class="popup_weightarticle1" alt="motivation2">
                    <p>It's extremely important to set goals &ndash; goals are what's at the heart of motivation! When we stop aiming for a goal, we forget why we are putting forth such an effort every day.</p>
                    <p>Consequently, without a goal, we stop trying so hard. When setting goals it is very important to set goals that are &quot;SMART,&quot; which includes the following:</p>
                    <h1>(1) Specific</h1>
                    <p>Make sure your goals are specific. For instance, just stating that you want to "lose weight" is not specific. If you want to lose weight, you need to state exactly how much weight you want to lose, though keep in mind, you can always change this amount later. </p>
                    <p>But you need to have a specific amount in mind that you are aiming for right from the beginning of your weight loss efforts!</p>
                    <h1>(2) Measurable</h1>
                    ...
                    <p>Ultimately, you want to be successful with your goals and being successful usually includes being flexible!</p>
                    <h2>(4) Realistic</h2>
                    <p>Your goals should be realistic. If your goals are not realistic, you may soon lose your motivation due to making such a strong effort and not feeling like you are much closer to attaining your goals.</p>
                    <p>It's great to expect the best from yourself and set "challenging" goals, but being realistic at the same time will facilitate you in maintaining your motivation throughout the process as well as in accomplishing them!</p>
                    ...
                    <p>Having a timely deadline will help keep you motivated because you know you do not have an endless amount of time by which to accomplish your goal! You are well aware that the clock is ticking!!!</p>
                    ...
                    <p>And make sure to write your goals down and keep them somewhere where you'll see them everyday. Also, have someone hold you accountable with your goals and subsequent actions. Just knowing someone is going to be checking in with you to make sure you are doing what you are suppose to be doing as well as what you said you would do, can be a much needed motivator!</p>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                   <img src="images/Increase2.png" class="popup_weightarticle1" alt="Increase2">
                    <p>In behavioral and sport psychology we like to say, &quot;The first key to gaining control over any situation is awareness.&quot; In order to tackle an obstacle that is plaguing your weight loss efforts, you first have to be aware of what that obstacle is.</p>
                    ...
                    <p>First, it allows us to become aware of what we are actually eating.</p>
                   	...
                   	<p> Because so many people 'pick' throughout the day, by days end most of us really aren't aware of how many different foods we have consumed.</p>
                    <p>When I have looked over a client's food journal and asked them about a specific food item they consumed, often times they will look at me quite puzzled, and say, &quot;Did I really eat that? I don't remember eating it.&quot;</p> Becoming aware of what you are actually eating is the first step towards becoming successful with your weight loss!

                    <h2>How much did I really eat?</h2>
                    <p>And of course there is the issue of "how much" you have consumed. By keeping track of what food items you have consumed and the amount for each of them, you can now see where you are consuming excess calories due to the sheer volume of what you have chosen to eat.</p>
                    ...
                    <h2>Don't do this</h2>
                    <p>A good example of why it's important to keep a food journal would be the case of eating chips right out of the bag. When we do this we aren't aware of how much we are consuming while we are eating them. And then we walk away after we're done not aware of how many calories all those chips just added up to. If we are keeping a food journal, we would have to write down how much we just ate which would facilitate us in determining how many calories we just consumed. One of the additional benefits to this is that since we are calories conscious, this would encourage us to measure out a specific amount the next time we reach for a bag of chips instead of just eating mindlessly!</p>

                    <h2>Summary</h2>
                    <p>Simply, keeping a food journal greatly facilitates us in becoming aware of what foods, and how much of them, we are consuming. It also helps us to determine how many total calories we are taking in for the entire day, as well as encourges us to measure foods out before cooking or eating them. Subsequently, when we are snacking we tend to consume less food and less calories which often times leads to losing weight faster, or not gaining the excess weight it in the first place!</p>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="popup_weightarticle_bottom">
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                    ...
                    <p>Many people who would like to manage their weight more effectively would like to start working out, but they have 'approach-avoidance' issues. Simply, they start to take steps that will lead them to working out each week, which is their "approach" phase. But then there is something that holds them back from following through and they never get started. This is their "avoidance" phase.  These individuals often will go through this same cycle many times in the future.</p>

<h1>FEAR</h1>
					<p>One main reason people have approach-avoidance issues towards working out, simply, is fear. Most of them have been in some type of gym setting before. But for many of them it was a long time ago! And they want to get back into working out, but avoid it because of fear. For starters, one thing they fear is that they will get hurt while working out because we know that we really don't know how to do the exercises or use the machines properly. So they avoid it altogether!</p>

<h1>NAGGING INJURIES</h1>
                    			<p>Interestingly enough, these individuals have good reason to believe they will get hurt. In addition to lacking enough knowledge about the equipment and exercises, another reason they might get hurt is that they have some areas of their body which are problematic, such as nagging injuries and tight spots. Not knowing how to compensate for these old injuries and tight areas can lead them to get hurt quite quickly and then decide that they are never working out again! Or if they do keep working out, they may totally avoid working out any body parts that involve these muscles, which can also be a very big mistake often-times.</p>

<h1>TARGET LIMITATIONS</h1>
					<p>One of the jobs of a good personal trainer is to first identify which areas of a client's body are weaknesses or have the potential to be troublesome. Then the client and trainer put together a plan that works out the entire body, with an emphasis on these limiting body parts. At first While working out the entire body, special attention is placed on keeping these areas out of harm's way. And additionally, learning how to stretch and strengthen these area needs to be addressed and become a priority.</p>

					<p>And lastly, possibly in addition to their other fears, many people fear that while trying to figure out how to use the equipment that they may look really, really dumb :) in the gym and they know they don't want to look or feel dumb! So they avoid the gym altogether for this reason as well.</p>

<h1>UTILIZE AVAILABLE RESOURCES</h1>
					<p>Simply, don't let fear (as rational as it might or might not be) get in your way of creating a better, healthier body. Utilize the help of a qualified personal trainer, as well as a physical therapist, to reach your goals. Getting started with an exercise program can be intimidating for many reasons, but you can utilize the help of others to get you started down the path to a healthier you. You have the power to get started, and if you do get started, you will likely be very glad that you did!</p>
                </div>
            ...
            <div class="popup_weightarticle_main">
                ...
                <div class="popup_weightarticle_contents">
                   <img src="images/2_ladies_on_mat_abs.jpg" class="popup_weightarticle1" alt="prevent_overeating2">
                    <p>Are you one of the many people who do not enjoy working out in a gym setting? Would you prefer to work out at home? Many people would and should consider this option. But before you get started working out at home or start an exercise program, get medical clearance from your physician first!</p>

<h1>BE IN THE KNOW!</h1>
                    <p>In order to burn calories and create a better body, you don't have to huff and puff in a gym setting with lots of strangers. You can get a great workout at home! However, you should know what to do and how to do it correctly to maximize effectiveness and minimize risk of injury.</p>

<h1>USE PROPER FORM</h1>
                    <p>For instance, if you want to lift dumbbells at home you might think 'lifting dumbbells is a no-brainer'. Well you're right in that it is not quantum physics, but like most everything else, there is a right and a wrong way to do it. One thing to keep in mind and focus on when lifting dumbbells is your form. For a lot of beginners, their form when it comes to this 'simple' task, is atrocious!</p>

<p>For example, whenever I walk past a fitness center that has large windows where you can easily look in and see lots of people lifting weights, I am almost always amazed as to the horrible form that many people use. Literally, it looks like they are working out a different body part than the body part that is intended to be worked by that exercise!</p>

<p>For instance, when doing standing dumbbell curls, their form is so bad that they seem to be working their shoulders and back more than their biceps. This sounds ridiculous because it is ridiculous!! So if you want to work out at home, make sure you know what proper form really looks like and use that form.</p>

<h1>PHYSICAL LIMITATIONS</h1>
<p>Keep in mind that proper form for you may be somewhat different than what it is for someone else because of physical limitations that you may have. And if your physical limitations lead you to think you need to use bad form, then either find out how to do that exercise properly from a qualified professional, or pick a different exercise. Don't use physical limitations as an excuse to workout improperly.</p>

<h1>LIMITED RESULTS</h1>
<p>Secondly, you need to know numerous exercises for each body part. You need to know this because if you only do the same exercise for a certain body part every time you workout that specific body part, your body will get used to that exercise quickly and you will stop seeing much, if any, improvement. So you need to know multiple exercises for each body part and how to do them correctly.</p>

<h1>CORE</h1>
<p>One of the most important things that should be addressed when starting (or re-starting) an exercise program is your core. Core includes, but is not limited to your abdominals, glutes, torso and lower back. In order to progress with exercises that use weights for any exercise, you will need to have strong core muscles for numerous reasons.</p>

<p>First, you don't want to pull any of your core muscles when working out because that will limit your choice of exercises after that since every exercise incorporates at least some of your core muscles. Plus, of course, nobody wants to pull or strain a muscle anywhere! All strength starts and emanates from the core so it is extremely important to get your core strong and then keep it strong.</p>

<p>Also, as you start to move up in weight with your exercises, you will notice a much greater need to have strong core muscles. Literally, if your core is weak you will find it difficult to utilize proper form for weight lifting exercises as the weight becomes heavier as you get stronger. So even if you don't pull a muscle with a weak core, it can negatively impact the progression of your workouts.</p>

<h1>TAKE-HOME MESSAGE</h1>
<p>The take-home message here is if working out at home works for you, consider doing it! But first find out what to do and how to do it correctly to maximize calorie burning and decrease risk of injury! Good luck!</p>
                </div>
