...
<h1>TARGET LIMITATIONS</h1>
					<p>One of the jobs of a good personal trainer is to first identify which areas of a client's body are weaknesses or have the potential to be troublesome. Then the client and trainer put together a plan that works out the entire body, with an emphasis on these limiting body parts. While working out the entire body, special attention is placed on keeping these areas out of harm's way. And additionally, learning how to stretch and strengthen these area needs to be addressed and become a priority!</p>
